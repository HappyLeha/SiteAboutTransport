...
if (w<=600) {
    ...
    document.getElementById("mobile").style.fontSize="xx-small";
    document.getElementById("minsk").style.fontSize="xx-small";
    
    }

document.getElementById("head").style.height=w*0.13;
document.getElementById("head").style.width=w*1.0025;
document.getElementById("head").style.marginLeft=-w*0.02+r;
